#
exportGGImage <- function(plot,output,format="png",width=3,height=3,resolution=150) {
    ...
    else ggsave(paste(output, format, sep = "."), plot, width=width,height=height,dpi=resolution)
}
#
